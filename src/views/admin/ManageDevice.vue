<template>
  <div class="max-w-6xl mx-auto p-6">
    ...
    <div class="flex items-center justify-between mb-6">
      <h1 class="text-2xl font-bold text-gray-800">Gestione Dispositivi</h1>
      <span class="text-sm text-gray-500">{{ filteredDevices.length }} Dispositivi</span>
    </div>
    ...
    <div v-if="showFilterPopUp" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div class="bg-white rounded-xl shadow-2xl p-6 max-w-md w-full mx-4">
        ...
        <div class="space-y-4">
          ...
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">ID Parcheggio</label>
            <select
      ...
      <div class="overflow-x-auto">
        <table class="w-full">
          ...
          <tr class="bg-gray-50 border-b border-gray-200">
            ...
            <th class="text-left py-3 px-4 text-sm font-semibold text-gray-600">ID Parcheggio</th>
          ...
          >
            ...
            <td class="py-3 px-4 text-sm text-gray-700">{{ device.parking_lot_id || 'N/A' }}</td>
            <td class="py-3 px-4">
